  ...
  <main>
    <section className="hero">
      ...
      <div className="hero-content">
        ...
        <form className="login-form">
          <div className="input-group">
            <input id="mail" type="email" placeholder="Adresse e-mail" required></input>
          </div>
          <div className="input-group">
          ...
          <p id="result"></p>
          <button id="submitbtn" type="button" className="btn btn-primary">Se connecter</button>
        </form>
      ...
      <div className="hero-image">
        <img src="./src/assets/e-Wallet6.gif" alt="Illustration de connexion"></img>
      </div>
