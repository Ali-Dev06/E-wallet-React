  ...
  users: [
    {
      ...
      wallet: {
        ...
        cards: [
          ...
          { numcards: "124478", type: "mastercard", balance: 1470, expiry: "2023-01-01", vcc: "257" }
        ],
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ahmed", to: "124847", state: "success" },
          { id: "2", type: "debit", amount: 200, date: "2025-08-13", from: "124847", to: "Amazon", state: "success" },
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ahmed", to: "124478", state: "success" }
        ],
        beneficiaries: [
    ...
    },
    {
      ...
      wallet: {
        ...
        currency: "MAD",
        cards: [
          { numcards: "224847", type: "visa", balance: 14712, expiry: "2024-05-20", vcc: "147" },
          { numcards: "224478", type: "mastercard", balance: 1470, expiry: "2028-08-14", vcc: "257" }
        ],
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ali", to: "12347", state: "success" },
          { id: "2", type: "debit", amount: 200, date: "2025-08-13", from: "12347", to: "Amazon", state: "success" },
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ali", to: "224478", state: "success" }
        ],
        beneficiaries: [
